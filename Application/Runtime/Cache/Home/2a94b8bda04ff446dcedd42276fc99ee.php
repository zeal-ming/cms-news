...
<section>
            ...
            <div class="col-sm-9 col-md-9">
                <div class="banner">
                    <div class="banner-left">
                        <div class="banner-info"><span>阅读数</span><i class="news_count node-<?php echo ($topPicNews['news_id']); ?>"
                                news-id="<?php echo ($topPicNews['news_id']); ?>"
                                id="node-<?php echo ($topPicNews['news_id']); ?>"><?php echo ($topPicNews['count']); ?></i></div>
                        <a target="_blank" href="/index.php?c=detail&id=<?php echo ($topPicNews['news_id']); ?>"><img
                                width="670" height="360" src="<?php echo ($topPicNews['thumb']); ?>" alt=""></a>
                    </div>
                    <div class="banner-right">
                        <ul>
                            <?php if(is_array($topSmallNews)): $i = 0; $__LIST__ = $topSmallNews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
  ...
  <div class="right-content">
    <ul>
      <?php if(is_array($news)): $k = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><li class="num<?php echo ($k); ?> curr">
  ...
  <?php if(is_array($advNews)): $k = 0; $__LIST__ = $advNews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><div class="right-hot">
