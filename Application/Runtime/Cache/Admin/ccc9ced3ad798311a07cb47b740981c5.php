...
<head>
    ...
    <script src="/Public/js/admin/dialog.js"></script>
...
<div id="wrapper">
    ...
    <?php
 $navs = D('Menu')->getMenu(); $index = 'index'; ?>
<!-- Navigation -->
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav side-nav nav_list" id="menu">
      <li <?php echo (getActive($index)); ?> id="souye">
      ...
      <li <?php echo (getActive($navo["c"])); ?>>
        <a href="<?php echo (getUrl($navo)); ?>"><i class="fa fa-fw fa-bar-chart-o"></i> <?php echo ($navo["name"]); ?></a>
                        ...
                        <form id="cms-listorder">
                            <table class="table table-bordered table-hover cms-table">
                                ...
                                <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td><input class="push" size=4 type='text' name='listorder[<?php echo ($new["news_id"]); ?>]' value="<?php echo ($new["listorder"]); ?>"/></td><!--6.7-->
                                        ...
                                        <td><span class="news_cursor glyphicon glyphicon-edit" aria-hidden="true" id="cms-edit" attr-id="<?php echo ($new["news_id"]); ?>"></span>
                                            <a href="javascript:void(0)" id="cms-delete" attr-status="<?php echo ($new["status"]); ?>"
                                               attr-id="<?php echo ($new["news_id"]); ?>" attr-message="删除">
...
<script>
    var SCOPE = {
        ...
        'jump_url': '/admin.php?c=content&a=index',
